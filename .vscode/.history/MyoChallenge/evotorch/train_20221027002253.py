...
if args.task == "baoding" :
    env_name = baoding_config["env_name"]
    load_policy_path_name = baoding_config["load_policy_path"]
    save_policy_path = baoding_config["save_policy_path"]
    env_config = baoding_config["env_config"]
else :
env_name = baoding_config["env_name"]
load_policy_path_name = baoding_config["load_policy_path"]
save_policy_path = baoding_config["save_policy_path"]
