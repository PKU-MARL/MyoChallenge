...
class ReorientEnvV0(BaseV0):
    ...
    def get_obs_dict(self, sim):
        ...
        # print(obs_dict['tip_pos'])
        # print(obs_dict['obj_pos'].reshape(1, 3))
        # print(np.linalg.norm(obs_dict['tip_pos'] - obs_dict['obj_pos'].reshape(1, 3), axis=-1))
        # exit()

        # print(self.my_tip_sids)
        # print(obs_dict['tip_pos'], obs_dict['obj_pos'])
        # print(sim.data.site_xvelp[self.object_sid], sim.data.site_xvelr[self.object_sid])
